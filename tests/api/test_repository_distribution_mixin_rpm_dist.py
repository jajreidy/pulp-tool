...
class TestRpmDistributionMixin:
    ...
    def test_create_rpm_distribution(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_get_rpm_distribution(self, mock_pulp_client, httpx_mock) -> None:
        ...
        httpx_mock.get(
            ...
            return_value=httpx.Response(
                ...
                json={
                    "results": [
                        {"pulp_href": "/api/v3/distributions/12345/", "name": "test-rpm-distro", "base_path": "test"}
                    ]
                },
            )
        )
    ...
    def test_list_rpm_distributions(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_update_rpm_distribution(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_delete_rpm_distribution(self, mock_pulp_client, httpx_mock) -> None:
...
class TestBaseRepositoryMixinDirect:
    ...
    def test_get_repository_direct(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_list_repositories_direct(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_update_repository_direct(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_delete_repository_direct(self, mock_pulp_client, httpx_mock) -> None:
...
class TestBaseDistributionMixinDirect:
    ...
    def test_get_distribution_direct(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_list_distributions_direct(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_update_distribution_direct(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_delete_distribution_direct(self, mock_pulp_client, httpx_mock) -> None:
