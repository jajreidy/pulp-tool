...
class TestArtifactMixin:
    ...
    def test_get_artifact(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_list_artifacts(self, mock_pulp_client, httpx_mock) -> None:
    ...
    def test_get_file_locations_with_chunked_get(self, mock_pulp_client, httpx_mock) -> None:
        ...
        class TestClient(ArtifactMixin):
            ...
            def _check_response(self, response, operation) -> None:
                pass
    ...
    def test_get_file_locations_fallback(self, mock_pulp_client, httpx_mock) -> None:
