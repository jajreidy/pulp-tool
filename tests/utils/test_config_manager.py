...
class TestConfigManagerInit:
    ...
    def test_init_with_base64(self) -> None:
...
class TestConfigManagerLoad:
    ...
    def test_load_cached_config(self) -> None:
    ...
    def test_load_io_error(self) -> None:
    ...
    def test_load_invalid_base64(self) -> None:
...
class TestConfigManagerGet:
    ...
    def test_get_loads_config_if_needed(self) -> None:
    ...
    def test_get_non_dict_value(self) -> None:
...
class TestConfigManagerGetSection:
    ...
    def test_get_section_loads_config_if_needed(self) -> None:
    ...
    def test_get_section_returns_empty_when_config_none(self) -> None:
    ...
    def test_get_section_existing(self) -> None:
...
class TestConfigManagerHasKey:
    ...
    def test_has_key_loads_config_if_needed(self) -> None:
    ...
    def test_has_key_handles_file_not_found(self) -> None:
        """Test has_key() returns False when config file not found (lines 129-132)."""
        manager = ConfigManager("/nonexistent/config.toml")
        result = manager.has_key("cli.base_url")
        assert result is False

    def test_has_key_handles_value_error(self) -> None:
    ...
    def test_has_key_existing_nested(self) -> None:
    ...
    def test_has_key_missing_key(self) -> None:
    ...
    def test_has_key_non_dict_value(self) -> None:
    ...
    def test_has_key_top_level(self) -> None:
