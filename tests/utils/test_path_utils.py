...
class TestEnsureDirectoryExists:
    ...
    def test_ensure_directory_exists_with_directory(self) -> None:
    ...
    def test_ensure_directory_exists_no_directory(self) -> None:
...
class TestJoinPath:
    ...
    def test_join_path_single_component(self) -> None:
        """Test join_path with single component."""
        result = join_path("file.txt")
        assert result == "file.txt"

    def test_join_path_multiple_components(self) -> None:
...
class TestGetBasename:
    ...
    def test_get_basename_simple_filename(self) -> None:
        """Test get_basename with simple filename."""
        result = get_basename("file.txt")
        assert result == "file.txt"

    def test_get_basename_no_path(self) -> None:
...
class TestGetDirname:
    ...
    def test_get_dirname_simple_filename(self) -> None:
        """Test get_dirname with simple filename."""
        result = get_dirname("file.txt")
        assert result == ""

    def test_get_dirname_root_path(self) -> None:
