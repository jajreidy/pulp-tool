...
class TestHandleHttpError:
    ...
    def test_handle_403_error(self, caplog) -> None:
    ...
    def test_handle_401_error(self, caplog) -> None:
...
class TestHandleGenericError:
    ...
    def test_handle_generic_error(self, caplog) -> None:
...
class TestWithErrorHandling:
    ...
    def test_successful_execution(self) -> None:
        ...
        def successful_func() -> None:
            return "success"

        result = successful_func()
        assert result == "success"

    def test_http_error_reraise(self) -> None:
    ...
    def test_generic_error_reraise(self) -> None:
    ...
    def test_error_no_reraise(self, caplog) -> None:
    ...
    def test_exit_on_error(self) -> None:
...
class TestLogAndExit:
    ...
    def test_log_and_exit_default(self, caplog) -> None:
    ...
    def test_log_and_exit_custom_code(self, caplog) -> None:
...
class TestTryParseJson:
    ...
    def test_parse_invalid_json_with_raise(self) -> None:
    ...
    def test_parse_invalid_json_no_default(self) -> None:
